...
def build_settings(payload: dict[str, Any] | None = None) -> Settings:
    ...
    return Settings(
        ...
        ntfy_match_edge_id=_coerce_text(_config_or_env(raw, "ntfy_match_edge_id", "NTFY_MATCH_EDGE_ID")),
        ntfy_match_edge_instance_id=_coerce_text(
            _config_or_env(raw, "ntfy_match_edge_instance_id", "NTFY_MATCH_EDGE_INSTANCE_ID")
        ),
        ntfy_match_source=_coerce_text(_config_or_env(raw, "ntfy_match_source", "NTFY_MATCH_SOURCE")),
